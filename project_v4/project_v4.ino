...
void loop() {
  ...
  */
  ...
  f32_correction = 0.0f;
  f32_correction = (kp * ((float)i32_GX_sum * f32_GX_conversion * f32_integration_time)) + (ki * ((float)i32_AY_sum * f32_AY_conversion * f32_integration_time)); //PI controller
  ...
  */
  ...
  /*Serial.print("i32_AY_sum: "); Serial.print(i32_AY_sum * f32_AY_conversion * f32_integration_time, 4);
  Serial.print("\ti16_AY: "); Serial.print(i16_AY * f32_AY_conversion, 4);
  Serial.print("\ti32_GX_sum: "); Serial.print(i32_GX_sum * f32_GX_conversion * f32_integration_time, 4);
  Serial.print("\ti16_GX: "); Serial.print(i16_GX * f32_GX_conversion, 4);
